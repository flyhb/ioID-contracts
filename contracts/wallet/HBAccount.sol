...
/**
 * @title HBAccount
 * @notice ERC-6551-style account with ERC721/1155 holding, EIP-1271, and safe call execution.
 *         Uses constructor-bound NFT metadata (chainId, tokenContract, tokenId).
 */
contract HBAccount is ERC165, IERC1271, ERC721Holder, ERC1155Holder, ReentrancyGuard {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        // add IERC1271 support on top of inherited interfaces
